...
/**
 * struct passinfo -> contains pseudo-argument to pass function,
 ...
 * @alias: alias node
 * @env_changed: on if environ has changed
...
typedef struct passinfo
{
	...
	char **cmd_bufcmd_buf; /* pointer to cmd ; chain buffer, for memory management */
